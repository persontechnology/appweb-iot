...
var m = (function () {
    ...
    y = (function (r) {
        ...
        function n(t, e, s) {
            ...
            return (
                ...
                (o.pusher = t),
                (o.options = s),
                (o.eventFormatter = new I(o.options.namespace)),
                o.subscribe(),
                o
            );
        }
        return (
            c(n, [
                ...
                },
                {
                    key: "listen",
                    value: function (e, s) {
                        return this.on(this.eventFormatter.format(e), s), this;
                    },
                },
                {
                    key: "listenToAll",
                    value: function (e) {
                        var s = this;
                        return (
                            this.subscription.bind_global(function (o, l) {
                                if (!o.startsWith("pusher:")) {
                                    var f = s.options.namespace.replace(
                                            /\./g,
                                            "\\"
                                        ),
                                        k = o.startsWith(f)
                                            ? o.substring(f.length + 1)
                                            : "." + o;
                                    e(k, l);
                                }
                            }),
                ...
                },
                {
                    key: "on",
                    value: function (e, s) {
                        return this.subscription.bind(e, s), this;
                    },
                },
            ]),
            n
    ...
    T = (function (r) {
        ...
        var i = h(n);
        function n() {
            return u(this, n), i.apply(this, arguments);
        }
        return (
            c(n, [
                {
                    ...
                    value: function (e) {
                        return (
                            this.on(
                                ...
                                function (s) {
                                    e(
                                        Object.keys(s.members).map(function (
                                            o
                                        ) {
                                            return s.members[o];
                                        })
        ...
        return (
            c(n, [
                ...
                },
                {
                    ...
                    value: function (e, s) {
                        return (
                            this.unbindEvent(this.eventFormatter.format(e), s),
                            this
                        );
                    },
                },
                ...
                },
                {
                    ...
                    value: function (e, s) {
                        ...
                        return (
                            ...
                            this.events[e] ||
                                ((this.events[e] = function (l, f) {
                                    o.name === l &&
                                        o.listeners[e] &&
                                        o.listeners[e].forEach(function (k) {
                                            return k(f);
                                        });
                                }),
            ...
            c(r, [
                {
                    key: "setOptions",
                    value: function (n) {
                        this.options = b(this._defaultOptions, n);
    ...
    F = (function (r) {
        ...
        function n() {
            var t;
            return (
                u(this, n), (t = i.apply(this, arguments)), (t.channels = {}), t
            );
        }
        return (
            c(n, [
                ...
                {
                    key: "listen",
                    value: function (e, s, o) {
                        return this.channel(e).listen(s, o);
                    },
                },
                {
                    key: "channel",
                    ...
                    value: function (e) {
                        return (
                            this.channels["presence-" + e] ||
                                (this.channels["presence-" + e] = new R(
                                    this.pusher,
                                    "presence-" + e,
                                    this.options
                                )),
            ...
            c(n, [
                    ...
                    value: function () {
                        ...
                        return (
                            ...
                            this.socket.on("reconnect", function () {
                                Object.values(e.channels).forEach(function (o) {
                                    o.subscribe();
                                });
                            }),
                            this.socket
                ...
                },
                {
                    ...
                    value: function (e) {
                        return (
                            this.channels["presence-" + e] ||
                                (this.channels["presence-" + e] = new N(
                                    this.socket,
                                    "presence-" + e,
                                    this.options
                                )),
            ...
            c(r, [
                ...
                },
                {
                    ...
                    value: function () {
                        this.options.broadcaster == "pusher"
                            ? (this.connector = new F(this.options))
                ...
                },
                {
                    ...
                    value: function (n, t, e) {
                        return this.connector.listen(n, t, e);
                    },
                },
                {
                    key: "private",
                ...
                },
                {
                    ...
                    value: function () {
                        typeof Vue == "function" &&
                            ...
                            (typeof Turbo > "u" ? "undefined" : d(Turbo)) ===
                                "object" &&
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        Vue.http.interceptors.push(function (t, e) {
                            n.socketId() &&
                                t.headers.set("X-Socket-ID", n.socketId()),
                                e();
                        });
                    },
                },
                {
                    ...
                    value: function () {
                        ...
                        axios.interceptors.request.use(function (t) {
                            return (
                                n.socketId() &&
                                    (t.headers["X-Socket-Id"] = n.socketId()),
                                t
                            );
                        });
                    },
                },
                {
                    ...
                    value: function () {
                        ...
                        typeof jQuery.ajax < "u" &&
                            jQuery.ajaxPrefilter(function (t, e, s) {
                                n.socketId() &&
                                    s.setRequestHeader(
                                        "X-Socket-Id",
                                        n.socketId()
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        document.addEventListener(
                            ...
                            function (t) {
                                t.detail.fetchOptions.headers["X-Socket-Id"] =
                                    n.socketId();
                            }
                        );
                    },
