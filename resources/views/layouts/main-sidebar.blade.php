...
<div class="sidebar sidebar-dark sidebar-main sidebar-expand-lg @hasSection('secondary-sidebar')
            ...
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                @role('ADMINISTRADOR')
                    ...
                    <li class="nav-item">
                        <a href="{{ route('clientes.index') }}"
                            class="nav-link {{ Route::is('clientes.*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('inquilinos.index') }}"
                            class="nav-link {{ Route::is('inquilinos.*') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('usuarios.index') }}"
                        class="nav-link {{ Route::is('usuarios.*') ? 'active' : '' }}">
                        <i class="ph ph-users"></i>
                        <span>
                            Usuarios
                        </span>
                ...
                <li class="nav-item">
                    <a href="{{ route('perfil-dispositivos.index') }}"
                        class="nav-link {{ Route::is('perfil-dispositivos.*') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('gateways.index') }}"
                        class="nav-link {{ Route::is('gateways.*') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('applicaciones.index') }}"
                        class="nav-link {{ Route::is('applicaciones.*') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('alertas.index') }}"
                        class="nav-link {{ Route::is('alertas.*') ? 'active' : '' }}">
                        <i class="ph ph-alarm"></i>
                        <span>
                            Alertas
                        </span>
                ...
                <li class="nav-item">
                    <a href="{{ route('lecturas.index') }}"
                        class="nav-link {{ Route::is('lecturas.*') ? 'active' : '' }}">
                        <i class="ph ph-alarm"></i>
                        <span>
                            Lecturas
                        </span>
