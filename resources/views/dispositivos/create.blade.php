            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        @else
                            @include('layouts.alert',['type'=>'danger','msg'=>'No existe perfil de dispositivos, por favor crear una.'])
                        @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-floating form-control-feedback form-control-feedback-start">
                            ...
                            <select class="form-select @error('tipo_dispositivo') is-invalid @enderror" name="tipo_dispositivo" required>
                                ...
                                <option value="{{ $tipoDispositivo->id }}" {{ old('tipo_dispositivo')==$tipoDispositivo->id?'selected':'' }}>{{ $tipoDispositivo->nombre }}</option>
                                @endforeach
                            </select>
