                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                                ...
                                <div class="form-floating form-control-feedback form-control-feedback-start">
                                    ...
                                    <select class="form-select @error('device_profile_id') is-invalid @enderror"
                                        ...
                                        @foreach ($perfil_dispositivos as $pd)
                                            <option value="{{ $pd->id }}"
                                                {{ old('device_profile_id') == $pd->id ? 'selected' : '' }}>
                                                {{ $pd->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            @else
                                @include('layouts.alert', [
                                    'type' => 'danger',
                                    'msg' => 'No existe perfil de dispositivos, por favor crear una.',
                                ])
                            @endif
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <div class="form-floating form-control-feedback form-control-feedback-start">
                                ...
                                <input type="text" name="dev_eui" value="{{ old('dev_eui') }}"
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <div class="form-floating form-control-feedback form-control-feedback-start">
                                ...
                                <input type="text" name="join_eui" value="{{ old('join_eui') }}"
                                    ...
                                    <select class="form-select @error('tipo_dispositivo') is-invalid @enderror"
                                        ...
                                        @foreach ($tipoDispositivos as $tipoDispositivo)
                                            <option value="{{ $tipoDispositivo->id }}"
                                                {{ old('tipo_dispositivo') == $tipoDispositivo->id ? 'selected' : '' }}>
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <div class="form-floating form-control-feedback form-control-feedback-start">
                                ...
                                <input type="number" name="battery_alert_level" value="{{ old('battery_alert_level') }}"
                    ...
                    <div class="col-lg-12">
                        <div class="mb-3">
                            <div class="form-floating form-control-feedback form-control-feedback-start">
                                ...
                                <input type="text" name="nwk_key" value="{{ old('nwk_key') }}"
